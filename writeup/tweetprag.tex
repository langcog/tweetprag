...
\label{eq:joint-entropy}     &=& H(T_j) - I(T_j;E_j,C_{j-1}) + H(E_j|C_{j-1})
\end{eqnarray}
% >>>>>>> 7f897ca1991f992053821df5b55978014e3418a0
...
\begin{figure}
 ...
 \caption{Total tweet entropy plotted against log tweet rate. Color reflects in-game time; line shows loess fit with 95\% confidence intervals.}\label{fig:rate-total-ent}\vspace*{-.5em}
\end{figure}
